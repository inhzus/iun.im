        ...
        .then(function (str) {
              ...
              .forEach(function (el) {
                ...
                if (css.inlines.filter(function (p) {
                  ...
                  if (!isCssBundle && bundleCssList.indexOf(href) < 0) {
                    ...
                    var tmp = doc.createElement('link');
                    tmp.rel = 'stylesheet';
                    tmp.href = href;
                    cssCode.push(tmp);
                    // cssCode += '<link href=\"' + href +'\" rel=\"stylesheet\">';
                    cssList.push(href);
                  }
                  hasDelivery = true;
                }
          ...
          if (hasDelivery) {
            if (bundleCssList.length > 0) {
              ...
              var tmp = doc.createElement('link');
              tmp.rel = 'stylesheet';
              tmp.href = root + 'style.css';
              cssCode.push(tmp);
              // cssCode = '<link href=\"' + root + 'style.css\" rel=\"stylesheet\">' + cssCode;
            }
            // eslint-disable-next-line
            // cssCode = "function loadCss(l){console.log(\"css\");var d=document,h=d.head,s=d.createElement('link');s.rel='stylesheet';s.href=l;!function e(f){if (d.body)return f();setTimeout(function(){e(f)})}(function(){h.appendChild(s);});}"
              // + cssCode;
              
            for (var i = 0; i < cssCode.length; i++) {
              doc.head.appendChild(cssCode[i]);
            }
            // doc.head.appendChild(cssElement);

            // doc.head.insertBefore(cssCode, doc.head.firstChild);
